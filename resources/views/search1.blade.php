...
<form action="{{ route('index.search') }}" class="d-flex">
    <div class="row mt-3 pl-3 ">
        ...
        <div class=" col-md-5 col-sm-12" >
            <input type="text" name="prenom" class="form-control" placeholder="Prenom" value="{{Request::get('prenom')}}"/>
        </div>

        <div class="col-md-5 col-sm-12" >
            <input type="text" name="nom" class="form-control" placeholder="Nom" value="{{Request::get('nom')}}" />
        </div>
